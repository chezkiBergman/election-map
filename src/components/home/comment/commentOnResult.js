                ...
                <AiFillCloseCircle onClick={onCloseClick} style={{position:"absolute",left:"1px"}} />
                    ...
                    <div style={{ display: "flex", }} >
                        <Form onSubmit={handelOnSubmit}>
                            <Form.Group >
                            <img style={{width:"25px",borderRadius:'25px',position:'absolute',left: '335px',top: '-143px'}} src={`http://localhost:3003/uploads/${token['img']}`}/>
                                <Form.Control value={comment} onChange={(e) => setComment(e.target.value)} placeholder="תגובה..." style={{ position: "absolute",width:'200px', top: '-119px',left: '335px' }} as="textarea" rows="3" />
                            </Form.Group>
