...
export default function CommentOrMap({activeMarker,setShowDiv,setClickedMap,setClickedComment}) {
    return (
        <div style={{ backgroundColor: activeMarker.color, opacity: 0.65, padding: 12 }}>
            ...
            {activeMarker.color === 'red' ? (<p style={{ color: "white", textAlign: 'center' }}>בעיר זו זכתה הקואליציה במירב הקולות</p>) : <p style={{ color: "white", textAlign: 'center' }}>בעיר זו זכתה האופוזיציה במירב הקולות</p>}
